...
"""
   ...
   Database functions related to maintaining the list of processed NLM
   archives.
...
def record_files_to_export(exports_list, db_con):
    """Mark files in exports_list as having been moved to
       the export directory.
    """


def check_exported_file_directory():
    """Determine if the exported files have been removed by
